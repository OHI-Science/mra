...
```{r , echo=FALSE}
library(readr)
ico_spp_biocode_cat <- read_csv("prep/SPP_ICO/ico_spp_biocode_cat.csv")
...
```{r , echo=FALSE}
library(readr)
ico_spp_rgn_cat <- read_csv("prep/SPP_ICO/ico_spp_rgn_cat.csv")
View(ico_spp_rgn_cat)View(ico_spp_biocode_cat)
```
